...
![No profile](images/no_profile.png)
...
![setup profile](images/setup_profile.png)

Then, when the profile is set, the user can create and manage safes.

![no safe](images/profile_set.png)
...
![safe reset password](images/safe_reset_password.png)

## Secrets management

When the user access a safe, the user can read, write, update, delete secrets and manage the safe.

![safe example](images/safe_example_detailed.png)
...
![Secret collapsed detailed](images/secret_collapsed_detailed.png)
...
![Secret expanded detailed](images/secret_expanded_detailed.png)
...
![Select secret icon](images/select_icon.png)
...
![Export secret](images/export_secret.png)
...
![Update rows](images/update_rows.png)
...
![Genrate password](images/generate_password.png)
...
![Genrate answer](images/generate_answer.png)

## Safe management

On the top right of the safe tab are the safe action buttons.

![Safe actions](images/safe_actions_detailed.png)
...
![Manage safe](images/manage_safe.png)
...
![Edit safe](images/edit_safe.png)
...
![History button](images/history_button.png)
